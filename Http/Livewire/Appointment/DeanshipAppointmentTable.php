...
use Lumis\StaffManagement\DataViews\DeanshipView;
use Lumis\StaffManagement\Entities\Deanship;
use Lumis\StaffManagement\Entities\Staff;
use Rappasoft\LaravelLivewireTables\DataTableComponent;
use Rappasoft\LaravelLivewireTables\Views\Column;

class DeanshipAppointmentTable extends DataTableComponent
{
    ...
    public function deleteAction()
    {
        if ($this->getSelectedCount() > 0) {
            foreach ($this->getSelected() as $key) {
                ...
                Deanship::getStaff($staff)->delete();
            }
