<div class="card card-outline">
    <div class="card-header">
        ...
        <div class="float-right">
            <a href="{{route('deanship.search')}}" class="btn btn-outline-primary">
                New Appointment
            </a>
        </div>
    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="faculty"
                                                class="form-control select3  @error('faculty') is-invalid @enderror">
                                            <option value="">--select--</option>
                                            @foreach ($viewBag->get('faculty') as $id => $name)
