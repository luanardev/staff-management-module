                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" wire:model.lazy="staff.official_email" name="official_email"
                                           class="form-control @error('staff.official_email') is-invalid @enderror"
                                           placeholder="Enter Official Email"/>
                                    @error('staff.official_email')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
