                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-widget widget-user-2">
                            ...
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <button wire:click="delete('{{$experience->id}}')" class="btn">Delete</button>
                                </div>
                            </div>
                            ...
                            <div class="card-footer p-0">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a class="float-right">
                                            <span class="text-bold text-sm">{{$experience->contact_email}}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a class="float-right">
                                            <span class="text-bold text-sm">{{$experience->contact_number}}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a class="float-right">
                                            <span class="text-bold text-sm">{{$experience->contact_address}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
