<div class="card card-outline">
    <div class="card-header">
        <h3 class="card-title text-bold">Contract Renewal</h3>
        <div class="float-right">
            <a href="{{route('contract.index')}}" class="btn btn-outline-primary">
                New Contract
            </a>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <form wire:submit.prevent="save">
                    <div class="card card-outline">
                        <div class="card-header">
                            <h3 class="card-title text-bold">Contract Form</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
